...
#define STRING_CONFIG_H_AUTHOR "(heinzi geetec ender3 marlin 2.1)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 500 } //BMG extruder uses something between 407-510
